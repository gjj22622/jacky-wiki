...
| **aischool** | **双云 AI Agent School 線上平台**（L0-L6 全 42 課章節全文 + 平台架構/權限分區/課程↔Skill 連動/部署監察；內容方法論連回 shuangyun 不複製）| 產品（線上學院）| 次要 | ✅ 已建（12 頁）|
...
```
                  ...
                  │ aischool ←──課程 ↔ 方法論母源──→ shuangyun  │  ← 新增
                  │ aischool ←──線上平台 ↔ 部署速查──→ portfolio │  ← 新增
                  └──────────────────────────────────────────┘
```
...
│   └── concepts/               # 教學定位 / 三工具軌 / AGENTS 對應 / AI Agent 定義
└── yinian/                     # 待建
