...
| **education** | **教育訓練——把實踐／方法論教給別人的對外成品（與 ailab 分工：個人事件→ailab、對外教材→education）｜🆕 LLM Wiki + Obsidian 關聯圖實戰 workshop（60 分鐘、8 步驟、5 採坑、含 15 張 slides）** | 19 | [進入](education/教育訓練索引.md) |
